...
* [Intro to Bayesian inference] \| First exposition to the concept of Bayesian parameter inference. [\[ html \]]({{ site.baseurl }}/code/bayesian_inference/binding_energy_inference.html) \| [\[ mlx \]]({{ site.baseurl }}/code/bayesian_inference/binding_energy_inference.mlx)
